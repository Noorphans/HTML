...
1. 在网页中，要把文字有条理地显示出来，就需要将这些文字分段显示。在 HTML 标签中，`<p>`标签用于`定义段落`，它可以将整个网页分为若干个段落。
...
![image-20231225102643790](http://images.newstar.net.cn/sally-imgsimage-20231225102643790.png) 

重点记住 **加粗strong** 和  **倾斜em**
...
![image-20231225161304326](http://images.newstar.net.cn/sally-imgsimage-20231225161304326.png) 
...
![image-20231226165727172](http://images.newstar.net.cn/sally-imgsimage-20231226165727172.png) 
